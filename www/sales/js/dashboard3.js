						...
						var cls="even";
					     if(i%2==0)
							...
							+ json.aggregations.Cust.buckets[i][4].buckets[0][5].buckets[0].key
							 ...
							 +numeral(json.aggregations.Cust.buckets[i][4].buckets[0][5].buckets[0][6].buckets[0][1].value.toFixed(0)/1000).format('0,0')
							+ "</td><td align=right>"
							/*
							+numeral(json.aggregations.Cust.buckets[i][4].buckets[0][5].buckets[0][6].buckets[0][2].value.toFixed(0)).format('0,0')
							+ "</td><td align=right>"*/
							+numeral(json.aggregations.Cust.buckets[i][4].buckets[0][5].buckets[0][6].buckets[0][8].value.toFixed(0)/1000).format('0,0')
							+ "</td><td align=right>"	
							+numeral(json.aggregations.Cust.buckets[i][4].buckets[0][5].buckets[0][6].buckets[0][12].value.toFixed(0)/1000).format('0,0')
							+ "</td></tr>";
