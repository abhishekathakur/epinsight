...
/* Render the dashboard */
	...
	$
			.ajax({
				...
				// data: {"search": search_term},
				success : function(json) {
					var rev = "<table><caption>YTD Month View</caption><thead><tr><td></td><td>Bud.</td><td>Act.</td><td>Prev.Act.</td><td>Growth</td></tr></thead><tbody><tr><th>Rev</th><td align=right>";
					var qnt = "<tr class=odd><th>Qty</th><td align=right>";
					var first_act = 0, sec_act = 0, first_qnt = 0, sec_qnt = 0;
					var rev_lcy=rev;
					/*
